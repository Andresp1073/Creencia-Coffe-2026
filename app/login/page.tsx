    ...
    try {
      ...
      if (!res.ok) {
        if (data.code === "INVALID_CREDENTIALS") {
          setError(
            "El usuario o la contraseña no son correctos. Por favor verifica e intenta nuevamente.",
          );
        } else if (data.code === "ACCOUNT_LOCKED") {
          setError(
            "Tu cuenta está temporalmente bloqueada. Intenta más tarde o contacta al administrador.",
          );
    ...
    >
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div
            className="mx-auto size-28 rounded-full flex items-center justify-center mb-4 bg-transparent"
            aria-hidden="true"
          >
            <img
              src="/favicon.png"
            ...
            <div>
              ...
              <div className="relative">
                <Input
                  ...
                  className={
                    errors.password
                      ? "border-destructive focus-visible:ring-destructive pr-12"
                      : "pr-12"
                  }
                />
                <button
