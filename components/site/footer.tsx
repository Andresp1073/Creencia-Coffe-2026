...
export function Footer() {
  return (
    <footer className="mt-24 bg-coffee-dark text-cream">
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-16 grid gap-12 md:grid-cols-3">
        <div>
          <div className="flex items-center gap-2.5 mb-4">
            <div className="size-9 rounded-full bg-cream/10 flex items-center justify-center">
...
<div>
          <h4 className="text-xs uppercase tracking-[0.18em] text-cream/50 mb-4">Contacto</h4>
          <ul className="space-y-2 text-sm text-cream/80">
            <li>
              <a
                ...
                className="hover:text-cream transition-smooth flex items-center gap-2"
              >
            ...
            <li>
              <a href="https://instagram.com/cafecreencia" target="_blank" rel="noopener noreferrer" className="hover:text-cream transition-smooth flex items-center gap-2">
      ...
      <div className="border-t border-cream/10">
        <div className="mx-auto max-w-7xl px-6 lg:px-10 py-6 text-xs text-cream/50 flex flex-col md:flex-row justify-between gap-2">
          <span>© {new Date().getFullYear()} Cafe Creencia. Todos los derechos reservados.</span>
